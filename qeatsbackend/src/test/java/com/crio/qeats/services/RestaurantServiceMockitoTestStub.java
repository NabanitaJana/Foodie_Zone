...
//   protected RestaurantServiceImpl restaurantService;
  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    /*  when(restaurantRepositoryServiceMock
            ...
            .findAllRestaurantsCloseBy(eq(20.0), eq(30.0),
                eq(LocalTime.of(3, 0)),
                eq(5.0)))  // Ensure this matches exactly with the method call in the implementation
            .thenReturn(Arrays.asList(restaurant1, restaurant2));
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    lenient().when(restaurantRepositoryServiceMock
          .findAllRestaurantsCloseBy(eq(20.0), eq(30.2),
              eq(LocalTime.of(3, 0)), eq(5.0)))
          .thenReturn(restaurantList1);

  lenient().when(restaurantRepositoryServiceMock
          .findAllRestaurantsCloseBy(eq(21.0), eq(31.1),
              eq(LocalTime.of(19, 0)), eq(3.0)))
          .thenReturn(restaurantList2);
